...
.. code-block:: python
   ...
   suite_config = {
       ...
       'value_transforms': [
           ...
           {'kind': 'oscillatory', 'probability': 0.25, 'parameters': [0.1, 1.0]},
       ...
       'compositions': [
           ...
           {'kind': 'cpm-level-well', 'probability': 0.2, 'parameters': [0.1, 1.0]},
           {'kind': 'dpm-softmax', 'probability': 0.25, 'parameters': [0.01]},
           {'kind': 'dpm-bgsoftmax', 'probability': 0.25, 'parameters': [0.01, 1.0, 0.01]},
       ],
       'min_components': 2,
       'max_components': 4,
